...
import 'package:word_/helper.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<FocusNode> _focusNodes2 =
      List<FocusNode>.generate(5, (int index) => FocusNode());
  List<FocusNode> _focusNodes3 =
      List<FocusNode>.generate(5, (int index) => FocusNode());
  List<FocusNode> _focusNodes4 =
      List<FocusNode>.generate(5, (int index) => FocusNode());
  List<FocusNode> _focusNodes5 =
      List<FocusNode>.generate(5, (int index) => FocusNode());
  List<FocusNode> _focusNodes6 =
      List<FocusNode>.generate(5, (int index) => FocusNode());

  List<TextEditingController> _textEditingControllers1 =
      List<TextEditingController>.generate(
          5, (int index) => TextEditingController(text: '\u200b'));
  List<TextEditingController> _textEditingControllers2 =
      List<TextEditingController>.generate(
          5, (int index) => TextEditingController(text: '\u200b'));
  List<TextEditingController> _textEditingControllers3 =
      List<TextEditingController>.generate(
          5, (int index) => TextEditingController(text: '\u200b'));
  List<TextEditingController> _textEditingControllers4 =
      List<TextEditingController>.generate(
          5, (int index) => TextEditingController(text: '\u200b'));
  List<TextEditingController> _textEditingControllers5 =
      List<TextEditingController>.generate(
          5, (int index) => TextEditingController(text: '\u200b'));
  List<TextEditingController> _textEditingControllers6 =
      List<TextEditingController>.generate(
          5, (int index) => TextEditingController(text: '\u200b'));

  List<List<TextEditingController>> _AllTextEditingController =
      List<List<TextEditingController>>.generate(
          6,
          (index) => List<TextEditingController>.generate(
              5, (index) => TextEditingController(text: '\ub200b')));
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> textFields1 = List<Widget>.generate(
        5,
        (int index) => Padding(
    ...
    List<Widget> textFields2 = List<Widget>.generate(
        5,
        (int index) => Padding(
              padding: const EdgeInsets.all(8.0),
              child: Container(
    ...
    List<Widget> textFields3 = List<Widget>.generate(
        5,
        (int index) => Padding(
              padding: const EdgeInsets.all(8.0),
              child: Container(
    ...
    List<Widget> textFields4 = List<Widget>.generate(
        5,
        (int index) => Padding(
              padding: const EdgeInsets.all(8.0),
              child: Container(
    ...
    List<Widget> textFields5 = List<Widget>.generate(
        5,
        (int index) => Padding(
              padding: const EdgeInsets.all(8.0),
              child: Container(
    ...
    List<Widget> textFields6 = List<Widget>.generate(
        5,
        (int index) => Padding(
              padding: const EdgeInsets.all(8.0),
              child: Container(
  ...
  void checkTextFiledWithRandomText1() {
    colorsRow1 = [];
    print(randomWord.contains(
        _textEditingControllers1[0].text.replaceAll('\u200b', '').trim()));
    ...
    for (var i = 0; i < _textEditingControllers1.length; i++) {
      ...
      if (randomWord.contains(
          _textEditingControllers1[i].text.replaceAll('\u200b', '').trim())) {
        print("Contains" + _textEditingControllers1[i].text);

        if (_textEditingControllers1[i].text.replaceAll('\u200b', '').trim() ==
            randomWord[i]) {
          //CORRECT
      ...
      if (_textEditingControllers1[i].text.replaceAll('\u200b', '').length ==
              0 ||
          _textEditingControllers1[i].text == "") {
  ...
  void checkTextFiledWithRandomText2() {
    ...
    for (var i = 0; i < _textEditingControllers2.length; i++) {
      ...
      if (_textEditingControllers2[i].text.replaceAll('\u200b', '').length ==
              0 ||
          _textEditingControllers2[i].text == "") {
  ...
  void checkTextFiledWithRandomText3() {
    ...
    for (var i = 0; i < _textEditingControllers3.length; i++) {
      ...
      if (_textEditingControllers3[i].text.replaceAll('\u200b', '').length ==
              0 ||
          _textEditingControllers3[i].text == "") {
  ...
  void checkTextFiledWithRandomText4() {
    ...
    for (var i = 0; i < _textEditingControllers4.length; i++) {
      ...
      if (_textEditingControllers4[i].text.replaceAll('\u200b', '').length ==
              0 ||
          _textEditingControllers4[i].text == "") {
  ...
  void checkTextFiledWithRandomText5() {
    ...
    for (var i = 0; i < _textEditingControllers5.length; i++) {
      ...
      if (_textEditingControllers5[i].text.replaceAll('\u200b', '').length ==
              0 ||
          _textEditingControllers5[i].text == "") {
  ...
  void checkIfCorrectWordFound(
      List<TextEditingController> textEditingController) {
    String words = "";
    List wordSearched = [];
    textEditingController.forEach((element) {
      wordSearched
          .add(element.text.replaceAll('\u200b', '').trim().toUpperCase());
  ...
  void showDialogue(bool win) {
    if (win) {
      Alert(
              context: context,
              title: 'You Win',
              desc: "Todays word was ${randomWord.toUpperCase()}")
          .show();
    } else {
      Alert(
              context: context,
